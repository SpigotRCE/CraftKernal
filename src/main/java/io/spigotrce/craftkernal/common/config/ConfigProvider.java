 ...
 * This class is responsible for loading, reloading, updating, and saving configuration files.
 */
public abstract class ConfigProvider {
    ...
    /**
     * Constructs a new ConfigProvider with the specified fileName and versioningTag.
     * The data directory is set to the plugin's data folder.
     */
    ...
    /**
     * This method is called when the configuration is reloaded.
     * It can be overridden by subclasses to perform additional actions after reloading.
     */
     ...
     * This method reads the configuration file again and updates the YamlDocument.
     *
     ...
     * This method applies any changes made to the YamlDocument and saves it to the file.
     *
     ...
     * This method writes the current state of the YamlDocument to the file.
     *
